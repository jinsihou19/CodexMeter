...
assert_equal "1.0.1" "$(release_read_project_setting "$ACTUAL_PROJECT_FILE" MARKETING_VERSION)" "工程语义版本"
assert_equal "2" "$(release_read_project_setting "$ACTUAL_PROJECT_FILE" CURRENT_PROJECT_VERSION)" "工程构建号"
